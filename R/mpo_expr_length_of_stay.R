mpo_expr$length_of_stay <- list()
mpo_expr$length_of_stay$expr <- rlang::expr({
...
mpo_expr$length_of_stay$infobox <- rlang::expr({
  data_env() |> 
...
mpo_expr$length_of_stay$datatable <- rlang::expr({
  data_env() |>
