  ...
  shiny::tagList(
    ...
    ui_row_box(title = "Guidance", shiny::HTML("
      <h4>HUD and Data Quality</h4>
        ...
        <p><span style='color:forestgreen;'>Green</span> dots here represent clients entered within the range and <span style='color:orangered;'>orange</span> lines (spanning the Entry Date to the Date the record was created) represent clients entered outside the range. The darker the dot, the more clients entered your project on that day. (Likely a household.)</p>
