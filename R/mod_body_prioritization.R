  ...
  moduleServer( id, function(input, output, session){
   ...
   output$header <- renderUI(server_header("Prioritization Report",
                              ...
                              shiny::div(
                                ...
                                shiny::strong("Notice: "),
                                "This report is a data export of individuals experiencing homelessness in the selected community and is not a prioritized list for Permanent Housing (PH) programs. Prioritization Workgroups should review and sort the report according to the community's established prioritization process. For assistance or additional guidance, please contact the Ohio BoSCoC Help Desk at ",
                                a("ohioboscoc@cohhio.org", href = "mailto:ohioboscoc@cohhio.org"),
                                "."
                              ),
