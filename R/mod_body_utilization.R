    ...
    output$infobox_pbn_available <-
      bs4Dash::renderInfoBox({
        ...
        bs4Dash::infoBox(
          ...
          color = "purple",
          icon = shiny::icon("bed"),
          value = sum(bed_count() * daysInMonth()),
          subtitle = paste(
            "Bed Count:",
            sum(bed_count()),
            "beds x",
